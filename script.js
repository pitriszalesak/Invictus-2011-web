...
function loadInstagramFeed() {
  ...
  instagramStatus.textContent = "Živý profil je aktivní";
  instagramUpdated.textContent = "Aktualizováno přímo Instagramem";
  document.querySelector(".instagram-live")?.classList.remove("is-fallback");
  loadInstagramEmbeds();
}
